 ...
 * minimum window so it reads as deliberate). Pure DOM — no WebGL canvas.
 */
export function LoadingScreen() {
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center gap-7 bg-arena-radial">
      <ScreenHeader subtitle="Loading the arena…" titleClassName="text-5xl" />
