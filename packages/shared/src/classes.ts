...
export const CLASS_DEFINITIONS: Record<CharacterClass, ClassDefinition> = {
  warrior: {
    ...
    stats: { health: 420, mana: 80, moveSpeed: 8, attackDamage: 45, difficulty: 1 },
  ...
  mage: {
    ...
    stats: { health: 280, mana: 260, moveSpeed: 8, attackDamage: 55, difficulty: 3 },
  ...
  archer: {
    ...
    stats: { health: 360, mana: 100, moveSpeed: 8, attackDamage: 40, difficulty: 2 },
  ...
  priest: {
    ...
    stats: { health: 340, mana: 180, moveSpeed: 8, attackDamage: 25, difficulty: 2 },
  ...
  ninja: {
    ...
    stats: { health: 300, mana: 120, moveSpeed: 8, attackDamage: 30, difficulty: 3 },
