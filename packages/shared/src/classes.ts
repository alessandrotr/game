...
export const CLASS_DEFINITIONS: Record<CharacterClass, ClassDefinition> = {
  warrior: {
    ...
    name: 'Warrior',
    role: 'Melee Bruiser',
    description: 'A durable frontliner who closes distance and disrupts with charges.',
    stats: { health: 140, mana: 60, moveSpeed: 6, attackDamage: 45, difficulty: 1 },
    abilities: ['charge'],
    color: '#b94b4b',
  },
  mage: {
    ...
    name: 'Mage',
    role: 'Ranged Burst',
    description: 'Glass-cannon caster: fireballs, a frost burst, a blink, and a meteor finisher.',
    stats: { health: 80, mana: 140, moveSpeed: 6, attackDamage: 55, difficulty: 3 },
    abilities: ['fireball', 'frost_nova', 'blink', 'meteor'],
    color: '#3a57d6',
  },
  archer: {
    id: 'archer',
    ...
    stats: { health: 100, mana: 90, moveSpeed: 7, attackDamage: 40, difficulty: 2 },
    abilities: ['fireball'],
    color: '#3f9d56',
  },
  priest: {
    ...
    stats: { health: 110, mana: 130, moveSpeed: 6, attackDamage: 25, difficulty: 2 },
    abilities: ['heal'],
    color: '#e8c45a',
  },
};
